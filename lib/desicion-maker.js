...
const convertTitle= title => {
  ...
  if(titleCopy.includes('handsmaids')) {
    titleCopy = specialPluralHandling(titleCopy)
  }
  return titleCopy
}

const specialPluralHandling = (title) => {
  const regex = /maids\b/gi;
  return title.replace(regex, 'aid-s')
}
